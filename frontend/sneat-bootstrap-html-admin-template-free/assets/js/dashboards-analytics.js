...
(function () {
  ...
  if (
    typeof totalRevenueChartEl !== undefined && totalRevenueChartEl !== null
  ) {
  ...
  if (
    typeof profileReportChartEl !== undefined && profileReportChartEl !== null
  ) {
  ...
  const chartOrderStatistics = document.querySelector("#orderStatisticsChart"),
    orderChartConfig = {
      ...
      labels: ["Disponíveis", "Ocupados", "Em Espera"],
      series: [50, 85, 25],
      colors: [
  ...
  if (
    typeof chartOrderStatistics !== undefined && chartOrderStatistics !== null
  ) {
